...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('i_ready_reading_mid_years', function (Blueprint $table) {
            $table->id();
            ...
            $table->longText('column_w')->comment('Diagnostic Gain (Note: negative gains=zero)')->nullable();
            ...
            $table->longText('column_ag')->comment('Diagnostic: Lexile Measure (Most Recent)')->nullable();
            $table->longText('column_ah')->comment('Diagnostic: Lexile Range (Most Recent)')->nullable();
    ...
    {
        Schema::dropIfExists('i_ready_reading_mid_years');
    }
};
