...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('star_fall_readings', function (Blueprint $table) {
            ...
            $table->dropColumn('column_m'); //Test 1 IRL
            $table->dropColumn('column_n'); //Test 1 ZPD
            $table->dropColumn('column_o'); //Test 1 Est. ORF
            $table->dropColumn('column_p'); //Test 2 Test Type
            $table->dropColumn('column_q'); //Test 2 Test Date
            $table->dropColumn('column_r'); //Test 2 Test Duration
            $table->dropColumn('column_s'); //Test 2 SS
            $table->dropColumn('column_t'); //Test 2 Benchmark Category
            $table->dropColumn('column_u'); //Test 2 PR
            $table->dropColumn('column_v'); //Test 2 NCE
            $table->dropColumn('column_w'); //Test 2 IRL
            $table->dropColumn('column_x'); //Test 2 ZPD
            $table->dropColumn('column_y'); //Test 2 Est. ORF
            $table->dropColumn('column_z'); //Latest Change in Score
            $table->dropColumn('column_aa'); //Latest Change in PR
            $table->dropColumn('column_ab'); //Latest Change in NCE
            $table->dropColumn('column_ac'); //Latest Change in IRL
            $table->dropColumn('column_ad'); //Latest Change in Est. ORF
            $table->dropColumn('column_ae'); //Student Id
        });
        Schema::table('star_fall_readings', function (Blueprint $table) {
