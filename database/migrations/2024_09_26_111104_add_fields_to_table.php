...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('i_ready_reading_minutes', function (Blueprint $table) {
            ...
            $table->longText('column_cr')->nullable()->comment('Year-to-Date Phonological Awareness Time on Task (min)');
            $table->longText('column_cs')->nullable()->comment('Year-to-Date Phonological Awareness Lessons Passed');
            $table->longText('column_ct')->nullable()->comment('Year-to-Date Phonological Awareness Lessons Completed');
            $table->longText('column_cu')->nullable()->comment('Year-to-Date Phonological Awareness % Lessons Passed');
            $table->longText('column_cv')->nullable()->comment('Year-to-Date Phonics Time on Task (min)');
            $table->longText('column_cw')->nullable()->comment('Year-to-Date Phonics Lessons Passed');
            $table->longText('column_cx')->nullable()->comment('Year-to-Date Phonics Lessons Completed');
            $table->longText('column_cy')->nullable()->comment('Year-to-Date Phonics % Lessons Passed');
            $table->longText('column_cz')->nullable()->comment('Year-to-Date High-Frequency Words Time on Task (min)');
            $table->longText('column_da')->nullable()->comment('Year-to-Date High-Frequency Words Lessons Passed');
            $table->longText('column_db')->nullable()->comment('Year-to-Date High-Frequency Words Lessons Completed');
            $table->longText('column_dc')->nullable()->comment('Year-to-Date High-Frequency Words % Lessons Passed');
            $table->longText('column_dd')->nullable()->comment('Year-to-Date Vocabulary Time on Task (min)');
            $table->longText('column_de')->nullable()->comment('Year-to-Date Vocabulary Lessons Passed');
            $table->longText('column_df')->nullable()->comment('Year-to-Date Vocabulary Lessons Completed');
            $table->longText('column_dg')->nullable()->comment('Year-to-Date Vocabulary % Lessons Passed');
            $table->longText('column_dh')->nullable()->comment('Year-to-Date Comprehension Time on Task (min)');
            $table->longText('column_di')->nullable()->comment('Year-to-Date Comprehension Lessons Passed');
            $table->longText('column_dj')->nullable()->comment('Year-to-Date Comprehension Lessons Completed');
            $table->longText('column_dk')->nullable()->comment('Year-to-Date Comprehension % Lessons Passed');
            $table->longText('column_dl')->nullable()->comment('Year-to-Date Comprehension: Close Reading Time on Task (min)');
            $table->longText('column_dm')->nullable()->comment('Year-to-Date Comprehension: Close Reading Lessons Passed');
            $table->longText('column_dn')->nullable()->comment('Year-to-Date Comprehension: Close Reading Lessons Completed');
            $table->longText('column_do')->nullable()->comment('Year-to-Date Comprehension: Close Reading % Lessons Passed');
            $table->longText('column_dp')->nullable()->comment('504 Plan');
            $table->longText('column_dq')->nullable()->comment('English Language Classification');
            $table->longText('column_dr')->nullable()->comment('Foster Youth');
            $table->longText('column_ds')->nullable()->comment('Gifted and Talented (GATE)');
            $table->longText('column_dt')->nullable()->comment('Homeless Youth');
            $table->longText('column_du')->nullable()->comment('Student with Disabilities');
